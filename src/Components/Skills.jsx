    ...
    transition={{duration:1.5}}
     ...
     {techs.map(({id,element,textColour,style})=>{
                                ...
                                return  <div className='flex relative group '>
                                  <div className={`flex justify-center items-center rounded-full border border-gray-500 h-24 w-24 xl:w-32 xl:h-32 filter  cursor-pointer ${style}`} key={id}>
                                  ...
                                  <div className='absolute opacity-0 group-hover:opacity-80 transition duration-300 ease-in-out h-24 w-24 xl:w-32 xl:h-32 hover:bg-white cursor-pointer rounded-full  '>
                                      <div className=' flex items-center justify-center h-full'>
                                        <p className=' text-sm 
                                        text-center font-bold opacity-100 uppercase text-black'>fhrfhrgfy</p>
                                      </div>
                                    </div>
                                    </div> 
                              }
