...
const Projects = () => {
  ...
  return (
    ...
    transition={{duration:1.5}}
     ...
     justify-evenly mx-auto items-center md:pb-[0.5rem] z-0 overflow-hidden'>
       <h3 className='absolute top-24 uppercase tracking-[20px] text-2xl'>Projects</h3>
       <div className='relative w-full flex overflow-x-scroll overflow-y-hidden scrollbar-thin scrollbar-track-gray-700 scrollbar-thumb-amber-500 snap-x snap-mandatory z-20'>
       {portfolios.map(({id,title,src,details,tech1,tech2,tech3,tech4,tech5,tech6,code,demo})=>
                                <div key={id} className=' w-screen flex flex-shrink-0 snap-start flex-col space-y-5 items-center justify-center p-20  md:p-36 h-screen '>
                                      <div className=' flex md:w-1/2 items-center justify-center pt-32 '>
                                        <motion.img 
                                        initial={{
                                          y:-200,
                                          opacity:0
                                        ...
                                        <div className='    px-0 md:px-10  '>  
                                                        <h4 className='text-xl font-semibold text-center underline decoration-[rgb(247,171,10)]/50'>{title}</h4>
                                                        <p className='text-justify md:text-center text-[14px] md:text-base py-4   '>{details}</p>
                                                <div className='flex justify-center items-center gap-3 font-semibold text-sm  uppercase pb-3'>
                                                        <p>{tech1}</p>
                                                        <p>{tech2}</p>
                                                        <p>{tech3}</p>
                                                        <p>{tech4}</p>
                                                ...
                                                <div className='flex justify-center items-center gap-4 '>
                                                      <a className='flex items-center justify-center gap-1 ' href={code}target='_blank' rel='noreferrer'> <BiLogoGithub className=' text-xl'/>Code</a>
